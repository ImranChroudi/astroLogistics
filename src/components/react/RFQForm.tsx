                ...
                return (
                  ...
                  >
                    <Checkbox.Root
                      ...
                      name="services"
                      value={service.id}
                      className="w-5 h-5 flex items-center justify-center border-2 border-gray-300 rounded data-[state=checked]:bg-[#00cc61] data-[state=checked]:border-blue-600 transition-colors shrink-0"
                    >
                      <Checkbox.Indicator>
