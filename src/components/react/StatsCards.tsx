    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
      {stats.map((stat, index) => {
        ...
        return (
          <div
            key={index}
            className="bg-white rounded-xl shadow-lg p-6 border border-gray-100 text-center group hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 Up"
          ...
          >
            ...
            <div className="text-4xl md:text-5xl font-bold bg-linear-to-r from-blue-600 to-teal-600 bg-clip-text  mb-2">
              {stat.value}
            </div>
